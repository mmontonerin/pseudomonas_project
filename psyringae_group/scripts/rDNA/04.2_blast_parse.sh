...
mkdir -p /home/montoliu/psyringae_group/results/rDNA/sequences
...
result="/home/montoliu/psyringae_group/results/rDNA/out" #results folder
seq="/home/montoliu/psyringae_group/results/rDNA/sequences" #extracted sequences folder
run="/home/montoliu/psyringae_group/scripts/rDNA" #scripts folder


# Create empty script that will be used to append the commands to extract the sequences
echo '#!/bin/bash' > ${run}/extract_blast_seq_16s.sh
...
do 
    ...
    }' ${result}/${aname}_16s.out >> ${run}/extract_blast_seq_16s.sh

done

# Make the script executable
chmod +x ${run}/extract_blast_seq_16s.sh

# Run the script to extract all sequences
${run}/extract_blast_seq_16s.sh 
