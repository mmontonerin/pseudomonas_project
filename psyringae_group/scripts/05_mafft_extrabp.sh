...
# Define directories:
seq="/home/montoliu/psyringae_group/results/sequences_selection_extrabp"
ali="/home/montoliu/psyringae_group/results/sequences_selection_extrabp/alignments" #extracted sequences folder
run="/home/montoliu/psyringae_group/scripts" #scripts folder

mkdir -p /home/montoliu/psyringae_group/results/sequences_selection_extrabp/alignments
