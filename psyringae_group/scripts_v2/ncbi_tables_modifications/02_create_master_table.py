...
# Read NCBI table in
df_ncbi = pd.read_csv('ncbi_psyringae_group_3016_genomes.csv', encoding='ascii', sep=',')

# Read filenames table, final table to be built from here
df_fn = pd.read_csv('filenames', encoding='ascii', header=0)

# Number genome assembly files.
# To be used for alignment methods that require very short names
ending_number = len(df_fn)
df_fn.insert(0, 'num', range(1, ending_number +1))
...
def extract_sequence_length(filename, main_directory, other_directory, endcontig_directory, endcontig_frag_directory):
    ...
    # Check if the sequence is in the end_contig or its fragmented directory
    endcontig_files = [f for f in os.listdir(endcontig_directory) if f.startswith(filename)]
    endcontig_frag_files = [f for f in os.listdir(endcontig_frag_directory) if f.startswith(filename)]
    if endcontig_files or endcontig_frag_files:
        sequence_length_str += "_end"

    return sequence_length_str

# Define directories
dirs = {
    'dnaQ': ('/home/montoliu/psyringae_group/results/sequences/dnaQ', '/home/montoliu/psyringae_group/results/sequences/fragmented/dnaQ', 
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/dnaQ',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/dnaQ'),
    'mutL': ('/home/montoliu/psyringae_group/results/sequences/mutL', '/home/montoliu/psyringae_group/results/sequences/fragmented/mutL',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/mutL',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/mutL'),
    'mutS': ('/home/montoliu/psyringae_group/results/sequences/mutS', '/home/montoliu/psyringae_group/results/sequences/fragmented/mutS',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/mutS',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/mutS'),
    'mutT': ('/home/montoliu/psyringae_group/results/sequences/mutT', '/home/montoliu/psyringae_group/results/sequences/fragmented/mutT',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/mutT',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/mutT'),
    'mutY': ('/home/montoliu/psyringae_group/results/sequences/mutY', '/home/montoliu/psyringae_group/results/sequences/fragmented/mutY',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/mutY',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/mutY'),
    'uvrD': ('/home/montoliu/psyringae_group/results/sequences/uvrD', '/home/montoliu/psyringae_group/results/sequences/fragmented/uvrD',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/uvrD',
             '/home/montoliu/psyringae_group/results/sequences_200extrabp_contig_completeness_endcontig/fragmented/uvrD')
}

# Apply the function to create gene columns
for gene, (main_dir, other_dir, endcontig, endcontigfrag) in dirs.items():
    df_fn[gene] = df_fn['filename'].apply(extract_sequence_length, args=(main_dir, other_dir, endcontig, endcontigfrag))
...
#quast directory
quast_directory = '/home/montoliu/psyringae_group/results/quast/stats_all'
...
for qstat, (quastdb_stat) in quast_stats.items():
    print(quastdb_stat)
    df_fn[qstat] = df_fn['filename'].apply(extract_assembly_stats, qstat=quastdb_stat)


####### BUSCO summary

busco_directory = '/home/montoliu/psyringae_group/results/BUSCO'

def extract_busco_results(filename, busco_stat):
    busco_results_file = os.path.join(busco_directory, f"short_summary.specific.pseudomonadales_odb10.{filename}.txt")     
...
for busco_stat in busco_stats:
    df_fn[busco_stat] = df_fn['filename'].apply(extract_busco_results, busco_stat=busco_stat)


# Write the DataFrame to a new CSV file
df_fn.to_csv('master_table.csv', index=False)
