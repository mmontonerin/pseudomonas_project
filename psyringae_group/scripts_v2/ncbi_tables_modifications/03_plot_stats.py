...
def plot_assembly_stats(input_file, output_name=None):
    ...
    if output_name:
        filename1 = f'contigs_distribution_{output_name}.pdf'
    else:
        filename1 = 'contigs_distribution.pdf'
    ...
    plt.text(0.95, 0.95, f'n = {n_samples}', ha='right', va='top', transform=plt.gca().transAxes)
    if output_name:
        filename2 = f'contigs_vs_total_length_{output_name}.pdf'
    else:
        filename2 = 'contigs_vs_total_length.pdf'
    ...
    plt.text(0.95, 0.95, f'n = {n_samples}', ha='right', va='top', transform=plt.gca().transAxes)
    if output_name:
        filename3 = f'contigs_vs_busco_{output_name}.pdf'
    else:
        filename3 = 'contigs_vs_busco.pdf'
