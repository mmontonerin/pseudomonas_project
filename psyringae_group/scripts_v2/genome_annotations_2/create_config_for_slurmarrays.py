...
prokka_script_files = glob.glob('/home/montoliu/psyringae_group/scripts_v2/genome_annotations_2/batch_scripts/prokka_commands_batch_*.sh')
...
for i in range(0, len(prokka_script_files), batch_size):
    ...
    config_filename = f"/home/montoliu/psyringae_group/scripts_v2/genome_annotations_2/config_files/config_batch_{config_counter}.txt"
