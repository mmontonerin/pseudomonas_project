...
# Read NCBI table
df = pd.read_csv('ncbi_assemblies_with_annotations.csv', encoding='ascii', sep=',')

path='/home/montoliu/psyringae_group/data/proteins_new_annotations_2'
...
for index, row in df.iterrows():
    ...
    prokka_command = f"prokka --cpus 8 --outdir {outdir} --prefix {accession} {fasta_path}\n"
...
for i in range(0, len(commands), batch_size):
    ...
    script_filename = f"/home/montoliu/psyringae_group/scripts_v2/genome_annotations_2/batch_scripts/prokka_commands_batch_{i // batch_size + 1}.sh"
