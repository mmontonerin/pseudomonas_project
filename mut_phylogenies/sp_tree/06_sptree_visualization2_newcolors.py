...
pdf_output = "/home/montoliu/mut_phylogenies/sp_tree/sptree_final_newcolors.pdf"
png_output = "/home/montoliu/mut_phylogenies/sp_tree/sptree_final_newcolors.png"
svg_output = "/home/montoliu/mut_phylogenies/sp_tree/sptree_final_newcolors.svg"
...
for node in t.traverse():
    ...
    if node.is_leaf():
        ...
        if species_name == "E. coli" or "P. viridiflava":
            text_color = "white"  # E. coli and P. viridiflava will have white text
        else:
...
t.render(pdf_output, tree_style=ts, dpi=2400, w=20000, h=20000, units="px")
t.render(png_output, tree_style=ts, dpi=2400, w=20000, h=20000, units="px")
#t.render(svg_output, tree_style=ts)
