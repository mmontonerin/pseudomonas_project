...
def find_unique_protein_clusters(mut_genes, input_directory, output_directory):
    ...
    for gene in mut_genes:
        fasta_file = os.path.join(input_directory, f"{gene}_mafft.fasta")
        output_fasta = os.path.join(output_directory, f"{gene}_clusters.fasta")
...
output_directory = "/home/montoliu/mut_phylogenies/mut_genes/cluster_for_visualization"
