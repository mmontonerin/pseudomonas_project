...
# Input files
tree_file = "./mut_sequences/alignments/mutH_id_mafft.fasta.treefile"
csv_file = "40_species.csv"
pdf_output = "./mut_sequences/alignments/mutH_tree.pdf"
png_output = "./mut_sequences/alignments/mutH_tree.png"
...
# outgroup_nodes = [leaf for leaf in t.iter_leaves() if abbr_to_order.get(leaf.name, "") == "Alphaproteobacteria"]
...
#     # Check if the MRCA is not already the root
#     if outgroup_mrca.up is not None:  # Only reroot if MRCA is not the root
#         t.set_outgroup(outgroup_mrca)
#         print("Tree rerooted at the common ancestor of the outgroups.")
#     else:
#         print("The outgroup MRCA is already the root of the tree.")
# else:
