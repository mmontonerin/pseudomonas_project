...
# Input files
tree_file = "./mut_sequences/alignments/mutS_id_mafft.fasta.treefile"
csv_file = "40_species.csv"
pdf_output = "./mut_sequences/alignments/mutS_tree.pdf"
png_output = "./mut_sequences/alignments/mutS_tree.png"
