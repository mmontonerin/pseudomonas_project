...
# Read NCBI table in
df = pd.read_csv('final_table_of_genome_assemblies_2.csv', encoding='ascii', sep=',')

# Copy extracted sequences and change the fasta header to ps_num, so that it can be used in alignments 

# List directories
path = "/home/montoliu/pprotegens/results/rDNA/sequences"
output_directory_seq = "/home/montoliu/pprotegens/results/rDNA/alignment" 
