...
# Read NCBI table in
df = pd.read_csv('/home/montoliu/pprotegens/01_select_assemblies/scripts/ncbi_tables_modifications/final_table_of_genome_assemblies_5.csv', encoding='ascii', sep=',')
