...
mkdir -p /home/montoliu/pprotegens/results/sequences_extrabp
mkdir -p /home/montoliu/pprotegens/results/sequences_extrabp/fragmented
...
result="/home/montoliu/pprotegens/results/blastn/blastn_out" #results folder
seq="/home/montoliu/pprotegens/results/sequences_extrabp" #extracted sequences folder
run="/home/montoliu/pprotegens/scripts" #scripts folder
frag="/home/montoliu/pprotegens/results/sequences_extrabp/fragmented" #extracted sequences folder for the frafmented assemblies
...
# If the range gets negative, turn to 0 instead

sed -i -E 's/range -[0-9]+/range 1/g;s/--[0-9]+ -strand/-1 -strand/g' ${run}/extract_blast_seq_extrabp.sh
sed -i -E 's/range -[0-9]+/range 1/g;s/--[0-9]+ -strand/-1 -strand/g' ${run}/extract_blast_seq_frag_extrabp.sh


# Make the script executable
chmod +x ${run}/extract_blast_seq_extrabp.sh
chmod +x ${run}/extract_blast_seq_frag_extrabp.sh

# Run the script to extract all sequences
${run}/extract_blast_seq_extrabp.sh &
${run}/extract_blast_seq_frag_extrabp.sh &
