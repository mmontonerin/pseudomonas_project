...
# Read NCBI table in
df = pd.read_csv('final_table_of_genome_assemblies_5.csv', encoding='ascii', sep=',')

# Create a separate folder with the fasta files as symlinks
output_directory = "/home/montoliu/pprotegens/data/assemblies_selection_final2"
os.makedirs(output_directory, exist_ok=True)

for filename in df['filename']:
    fasta_file = os.path.join('/home/montoliu/pprotegens/data/assemblies', f'{filename}.fasta')
...
path = "/home/montoliu/pprotegens/01_select_assemblies/results/sequences_extrabp"
output_directory_seq = "/home/montoliu/pprotegens/01_select_assemblies/results/sequences_extrabp_selection" 
