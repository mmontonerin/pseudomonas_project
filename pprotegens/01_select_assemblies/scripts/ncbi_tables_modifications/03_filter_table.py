...
def filter_table(input_file):
    ...
    df_condition_fail.to_csv('filter_out_5.csv', index=False)

    # Save unfiltered data to another file
    df_condition_pass.to_csv('final_table_of_genome_assemblies_5.csv', index=False)

# Pprotegens
# Filter 1 only no fragmented
...
# BUSCO 90%
# min length = 6000000
#*max length 10Mb (to not have a limit)

#Filter 4
# BUSCO 95%

#Filter 5
# No Ns allowed in genes
