...
prokka_script_files = glob.glob('/home/montoliu/pprotegens/01_select_assemblies/scripts/genome_annotation/batch_scripts/prokka_commands_batch_*.sh')
...
for i in range(0, len(prokka_script_files), batch_size):
    ...
    config_filename = f"/home/montoliu/pprotegens/01_select_assemblies/scripts/genome_annotation/config_files/config_batch_{config_counter}.txt"
