...
def find_unique_protein_clusters(mut_genes, input_directory, output_directory, csv_file, output_csv):
    ...
    for gene in mut_genes:
        ...
        df[column_name] = df['ppro_num'].apply(find_cluster)
        
        # Debugging: Check for unmatched IDs
        unmatched = [num for num in df['ppro_num'] if num not in sequence_to_cluster]
...
input_directory = "/home/montoliu/pprotegens/mut_genes/protein_analysis/alignments"
output_directory = "/home/montoliu/pprotegens/mut_genes/protein_analysis/alignments/clusters"
csv_file = "ppro_master_table_num_precluster.csv"
output_csv = "ppro_master_table_clusters.csv"
