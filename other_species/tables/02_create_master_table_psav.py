...
# Read NCBI table in
df_ncbi = pd.read_csv('psav.csv', encoding='ascii', sep=',')

# Read filenames table, final table to be built from here
df_fn = pd.read_csv('psav_assembly_names.txt', encoding='ascii', header=0)
...
#quast directory
quast_directory = '/home/montoliu/other_species/data/quast/psav/stats_all'
...
busco_directory = '/home/montoliu/other_species/data/busco/psav'
...
df_fn.to_csv('psav_mastertable_stats.csv', index=False)
