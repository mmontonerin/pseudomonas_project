...
# Read NCBI table in
df_ncbi = pd.read_csv('pflu.csv', encoding='ascii', sep=',')

# Read filenames table, final table to be built from here
df_fn = pd.read_csv('pflu_assembly_names.txt', encoding='ascii', header=0)
...
#quast directory
quast_directory = '/home/montoliu/other_species/data/quast/pflu/stats_all'
...
busco_directory = '/home/montoliu/other_species/data/busco/pflu'
...
df_fn.to_csv('pflu_mastertable_stats.csv', index=False)
